...
/*///////////////////////////P I D///////////////////////////////////*/
/*Remember that for the balance we will use just one axis. I've choose the y angle
to implement the PID with. That means that the y axis of the IMU has to be parallel to
the balance*/
...
have a value of 2000us the maximum value that we could subtract is 1000 and when
...
esc[0][0].writeMicroseconds(map(pwmRight,1000,2000,1000,range[0][0]));
//map esc[1][1] to 1000,1500
esc[1][1].writeMicroseconds(map(pwmLeft,1000,2000,1000,2000));
